...
//     if( $("#phone").val()==""){
//         $(".errorMsgOut").css("display","block");
//         $(".baocuo").html('请输入您的手机号');
//     }else if(!(patt1.test($("#phone").val()))){
//         $(".baocuo").html("请输入正确的手机号");
//         $(".errorMsgOut").eq(0).css("display","block")
//     }else if($("#password").val()==""){
//         $(".errorMsgOut").css("display","block");
//         $(".baocuo").html('请输入您的密码');
//     }else if(!(patt2.test($("#password").val()))){
//         $(".baocuo").html("请输入正确的密码");
//         $(".errorMsgOut").eq(0).css("display","block")
//     }else{
//         $(".errorMsgOut").eq(0).css("display","none")
//     }
// })
...
$("#loginBtn").click(function(){
    if( $("#phone").val()==""){
        ...
        $(".errorMsgOut").css("display","block");
        $(".baocuo").html('请输入您的验证码');   
    }else if(!(($("#r-content-from-input").val())==verifyCode.options.code.toLowerCase())){
        $(".baocuo").html("请输入正确的验证码");
        $(".errorMsgOut").eq(0).css("display","block");
        // $(".errorMsgOut").eq(0).css("display","none");
    }else{
        $(".errorMsgOut").eq(0).css("display","none")
